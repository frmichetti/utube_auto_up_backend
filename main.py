...
def get_authenticated_service(args):  
  ...
  fullPathSecret = os.path.abspath(os.path.join( 
      os.path.dirname(__file__),CLIENT_SECRETS_FILE))

  fullPathStorageFile = os.path.abspath(os.path.join( 
      os.path.dirname(__file__),"main.py-oauth2.json")) 
...
def initialize_upload(youtube, options, args):
  tags = None
  if options.keywords:
